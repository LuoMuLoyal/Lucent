...
export function buildAssistantSystemPrompt(
  ...
  return [
    ...
    'The `qa` source of search_cn_medicine_knowledge is an open corpus of low-trust educational reference material, not a curated database. Treat its content as reference only, never as medical conclusions; do not diagnose diseases or prescribe medications. Always remind users to consult a doctor.',
