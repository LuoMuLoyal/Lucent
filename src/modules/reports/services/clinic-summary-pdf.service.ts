...
export class ClinicSummaryPdfService {
  async buildPdf(summary: ClinicSummaryDto, locale: string): Promise<Buffer> {
    ...
    const footerNote = isZh
      ? '由 Lumos 自动生成，仅供就诊参考，不替代专业医疗诊断。'
      : 'Auto-generated by Lumos for clinic reference only. Not a substitute for professional medical diagnosis.';
    ...
    this.drawProfileTable(context, summary, isZh, cjkFont);
    context.cursorY -= 12;
    ...
    this.drawMedicinesSection(context, summary.currentMedicines, isZh, cjkFont);
    context.cursorY -= 8;
