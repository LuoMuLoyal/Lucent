...
- [[Assistant_Runtime]] — Assistant 运行时、检索链路、LangGraph tool-loop
- [[Today_Suggestion_Engine]] — Today 主动建议引擎
- [[Medicine_Data_RAG]] — 药品知识库、RAG 索引、dose log 合同
- [[Meal_Analysis]] — 餐食分析管道
- [[Report_Export]] — 报告导出、PDF 生成
- [[Auth_Security_PIN]] — 认证、OAuth、Security PIN、安全配置
- [[Public_Support_Resources]] — 公共支持资源、法律文档管理 API

### 工具链与质量

- [[01-reference/toolchain]] — 工具链、OpenAPI 合同、Git hooks、环境变量解析
- [[01-reference/code-quality]] — 代码质量、模块结构、测试覆盖
