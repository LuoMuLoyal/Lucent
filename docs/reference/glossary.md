...
- **P0–P3 优先级体系** — 跨项目产品优先级框架，定义于 `Luminous/docs/archive/product/Product_Brainstorm_2026-07-07.md`（已归档）。P0 为发布前必做项，P1 为首发版本内，P2 为 1.1.0 候选，P3 为 1.2.0+ 候选。核心主闭环是 `记录 -> 主动建议卡 -> 用户确认动作 -> 回顾`。
