...
| 文件                                          | 原方式                                 | 新方式                                   |
| --------------------------------------------- | -------------------------------------- | ---------------------------------------- |
| `clinic-summary.service.ts`                   | `process.env['PUBLIC_BASE_URL']`       | `configService.get('app').publicBaseUrl` |
| `assistant-tool-medical-knowledge.service.ts` | `process.env['DATABASE_URL']`          | `configService.get('DATABASE_URL')`      |
| 同上                                          | `process.env` 读 AI embedding 三个 key | `configService.get('ai').embedding`      |
| `assistant-tool-leaflet-read.service.ts`      | 同上                                   | 同上                                     |
| `assistant-tool-leaflet-read.service.spec.ts` | `process.env` 模拟                     | mock `ConfigService`                     |
